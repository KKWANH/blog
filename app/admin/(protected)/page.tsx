    ...
    <main>
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="mt-3 text-4xl font-bold tracking-tight dark:font-sans font-serif">Admin Overview</h1>
      ...
      <section className="mt-8 grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
        <article className="border border-border bg-card p-6">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h2 className="mt-3 text-2xl font-semibold dark:font-sans font-serif">Recently published articles</h2>
            </div>
        ...
        <div className="grid gap-6">
          ...
          <article className="border border-border bg-card p-6">
            ...
            <h2 className="mt-3 text-2xl font-semibold dark:font-sans font-serif">Analytics & performance</h2>
