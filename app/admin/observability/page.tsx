      ...
      <main>
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-4xl font-bold tracking-tight font-serif dark:font-sans">
        ...
        <section className="mt-8 border border-border bg-card p-6">
          <div className="grid gap-3 text-sm md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 break-all font-medium">{siteUrl}</p>
            </div>
            <div>
            ...
            return (
              <article key={check.title} className="border border-border bg-card p-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-xl font-semibold font-serif dark:font-sans">{check.title}</h2>
                </div>
